...
class EmployeeManager {
	...
	public void addEmployee(int empId, String firstName, String lastName, String department) {
		if (!isValidName(firstName) && !isValidName(lastName)) {
			...
			logError("Invalid firstname & last name format - Last name: " + firstName + lastName);
			return;
		}
	...
	static void displaySortedEmployeeRecords(EmployeeManager manager, Comparator<Employee> comparator) {
